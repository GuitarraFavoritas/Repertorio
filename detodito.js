...
const detoditoInDB = ref(database, "detodito")
...
const detoditoEl = document.getElementById("detodito-ul")
...
onValue(detoditoInDB, function(snapshot) {
...
function cleardetoditoEl() {
  detoditoEl.innerHTML = ""
}
...
function appendItemTodetoditoEl(item) {
    let itemID = item[0]
  ...
  newEl.addEventListener("dblclick", function() {
    ...
    let exactLocationOfItemInDB = ref(database, `detodito/${itemID}`)
